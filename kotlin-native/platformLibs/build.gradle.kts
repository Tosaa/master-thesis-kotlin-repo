...
fun platformDirectory(family : Family, architecture: org.jetbrains.kotlin.konan.target.Architecture) = "src/platform/${family.visibleName}" + if(architecture.toString().contains("RISCV")) "_for_riscv" else ""
