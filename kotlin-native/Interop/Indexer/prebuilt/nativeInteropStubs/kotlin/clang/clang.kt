...
@ExperimentalForeignApi
enum class CXChoice(value: Int) : CEnum {
    CXChoice_Default(0),
    CXChoice_Enabled(1),
    CXChoice_Disabled(2),
    ;
    ...
    companion object {
        ...
        @Deprecated("Will be removed.", ReplaceWith(""), DeprecationLevel.WARNING)
        fun byValue(value: Int): CXChoice = values().find { it.value == value }!!
    }
...
fun clang_getFileName(SFile: CXFile?): CValue<CXString> {
    ...
    try {
        kniBridge3(SFile.rawValue, kniRetVal.rawPtr)
...
fun clang_getFileTime(SFile: CXFile?): time_t {
    return kniBridge4(SFile.rawValue)
}

@ExperimentalForeignApi
fun clang_getFileUniqueID(file: CXFile?, outID: CValuesRef<CXFileUniqueID>?): Int {
    memScoped {
        return kniBridge5(file.rawValue, outID?.getPointer(memScope).rawValue)
    }
}

@ExperimentalForeignApi
fun clang_File_isEqual(file1: CXFile?, file2: CXFile?): Int {
    return kniBridge6(file1.rawValue, file2.rawValue)
}
...
fun clang_File_tryGetRealPathName(file: CXFile?): CValue<CXString> {
    val kniRetVal = nativeHeap.alloc<CXString>()
    try {
        kniBridge7(file.rawValue, kniRetVal.rawPtr)
        return kniRetVal.readValue()
    } finally { nativeHeap.free(kniRetVal) }
}
...
fun clang_equalLocations(loc1: CValue<CXSourceLocation>, loc2: CValue<CXSourceLocation>): Int {
    memScoped {
        return kniBridge9(loc1.getPointer(memScope).rawValue, loc2.getPointer(memScope).rawValue)
    }
}
...
fun clang_Location_isInSystemHeader(location: CValue<CXSourceLocation>): Int {
    memScoped {
        return kniBridge10(location.getPointer(memScope).rawValue)
    }
}
...
fun clang_Location_isFromMainFile(location: CValue<CXSourceLocation>): Int {
    memScoped {
        return kniBridge11(location.getPointer(memScope).rawValue)
    }
}
...
fun clang_getRange(begin: CValue<CXSourceLocation>, end: CValue<CXSourceLocation>): CValue<CXSourceRange> {
    memScoped {
        val kniRetVal = nativeHeap.alloc<CXSourceRange>()
        try {
            kniBridge13(begin.getPointer(memScope).rawValue, end.getPointer(memScope).rawValue, kniRetVal.rawPtr)
            return kniRetVal.readValue()
        } finally { nativeHeap.free(kniRetVal) }
    }
}
...
fun clang_equalRanges(range1: CValue<CXSourceRange>, range2: CValue<CXSourceRange>): Int {
    memScoped {
        return kniBridge14(range1.getPointer(memScope).rawValue, range2.getPointer(memScope).rawValue)
    }
}
...
fun clang_Range_isNull(range: CValue<CXSourceRange>): Int {
    memScoped {
        return kniBridge15(range.getPointer(memScope).rawValue)
    }
}
...
fun clang_getExpansionLocation(location: CValue<CXSourceLocation>, file: CValuesRef<CXFileVar>?, line: CValuesRef<IntVar>?, column: CValuesRef<IntVar>?, offset: CValuesRef<IntVar>?): Unit {
    memScoped {
        return kniBridge16(location.getPointer(memScope).rawValue, file?.getPointer(memScope).rawValue, line?.getPointer(memScope).rawValue, column?.getPointer(memScope).rawValue, offset?.getPointer(memScope).rawValue)
    }
}
...
fun clang_getPresumedLocation(location: CValue<CXSourceLocation>, filename: CValuesRef<CXString>?, line: CValuesRef<IntVar>?, column: CValuesRef<IntVar>?): Unit {
    memScoped {
        return kniBridge17(location.getPointer(memScope).rawValue, filename?.getPointer(memScope).rawValue, line?.getPointer(memScope).rawValue, column?.getPointer(memScope).rawValue)
    }
}
...
fun clang_getInstantiationLocation(location: CValue<CXSourceLocation>, file: CValuesRef<CXFileVar>?, line: CValuesRef<IntVar>?, column: CValuesRef<IntVar>?, offset: CValuesRef<IntVar>?): Unit {
    memScoped {
        return kniBridge18(location.getPointer(memScope).rawValue, file?.getPointer(memScope).rawValue, line?.getPointer(memScope).rawValue, column?.getPointer(memScope).rawValue, offset?.getPointer(memScope).rawValue)
    }
}
...
fun clang_getSpellingLocation(location: CValue<CXSourceLocation>, file: CValuesRef<CXFileVar>?, line: CValuesRef<IntVar>?, column: CValuesRef<IntVar>?, offset: CValuesRef<IntVar>?): Unit {
    memScoped {
        return kniBridge19(location.getPointer(memScope).rawValue, file?.getPointer(memScope).rawValue, line?.getPointer(memScope).rawValue, column?.getPointer(memScope).rawValue, offset?.getPointer(memScope).rawValue)
    }
}
...
fun clang_getFileLocation(location: CValue<CXSourceLocation>, file: CValuesRef<CXFileVar>?, line: CValuesRef<IntVar>?, column: CValuesRef<IntVar>?, offset: CValuesRef<IntVar>?): Unit {
    memScoped {
        return kniBridge20(location.getPointer(memScope).rawValue, file?.getPointer(memScope).rawValue, line?.getPointer(memScope).rawValue, column?.getPointer(memScope).rawValue, offset?.getPointer(memScope).rawValue)
    }
}
...
fun clang_getRangeStart(range: CValue<CXSourceRange>): CValue<CXSourceLocation> {
    memScoped {
        val kniRetVal = nativeHeap.alloc<CXSourceLocation>()
        try {
            kniBridge21(range.getPointer(memScope).rawValue, kniRetVal.rawPtr)
            return kniRetVal.readValue()
        } finally { nativeHeap.free(kniRetVal) }
    }
}
...
fun clang_getRangeEnd(range: CValue<CXSourceRange>): CValue<CXSourceLocation> {
    memScoped {
        val kniRetVal = nativeHeap.alloc<CXSourceLocation>()
        try {
            kniBridge22(range.getPointer(memScope).rawValue, kniRetVal.rawPtr)
            return kniRetVal.readValue()
        } finally { nativeHeap.free(kniRetVal) }
    }
}
...
fun clang_disposeSourceRangeList(ranges: CValuesRef<CXSourceRangeList>?): Unit {
    memScoped {
        return kniBridge23(ranges?.getPointer(memScope).rawValue)
    }
}

@ExperimentalForeignApi
fun clang_Error_getCode(arg0: CXError?): CXErrorCode {
    return CXErrorCode.byValue(kniBridge24(arg0.rawValue))
}

@ExperimentalForeignApi
fun clang_Error_getDescription(arg0: CXError?): CPointer<ByteVar>? {
    return interpretCPointer<ByteVar>(kniBridge25(arg0.rawValue))
}

@ExperimentalForeignApi
fun clang_Error_dispose(arg0: CXError?): Unit {
    return kniBridge26(arg0.rawValue)
}
...
fun clang_VirtualFileOverlay_create(options: Int): CXVirtualFileOverlay? {
    return interpretCPointer<CXVirtualFileOverlayImpl>(kniBridge28(options))
}

@ExperimentalForeignApi
fun clang_VirtualFileOverlay_addFileMapping(arg0: CXVirtualFileOverlay?, virtualPath: String?, realPath: String?): CXErrorCode {
    memScoped {
        return CXErrorCode.byValue(kniBridge29(arg0.rawValue, virtualPath?.cstr?.getPointer(memScope).rawValue, realPath?.cstr?.getPointer(memScope).rawValue))
    }
}

@ExperimentalForeignApi
fun clang_VirtualFileOverlay_setCaseSensitivity(arg0: CXVirtualFileOverlay?, caseSensitive: Int): CXErrorCode {
    return CXErrorCode.byValue(kniBridge30(arg0.rawValue, caseSensitive))
}
...
fun clang_VirtualFileOverlay_writeToBuffer(arg0: CXVirtualFileOverlay?, options: Int, out_buffer_ptr: CValuesRef<CPointerVar<ByteVar>>?, out_buffer_size: CValuesRef<IntVar>?): CXErrorCode {
    memScoped {
        return CXErrorCode.byValue(kniBridge31(arg0.rawValue, options, out_buffer_ptr?.getPointer(memScope).rawValue, out_buffer_size?.getPointer(memScope).rawValue))
    }
}
...
fun clang_free(buffer: CValuesRef<*>?): Unit {
    memScoped {
        return kniBridge32(buffer?.getPointer(memScope).rawValue)
    }
}

@ExperimentalForeignApi
fun clang_VirtualFileOverlay_dispose(arg0: CXVirtualFileOverlay?): Unit {
    return kniBridge33(arg0.rawValue)
}

@ExperimentalForeignApi
fun clang_ModuleMapDescriptor_create(options: Int): CXModuleMapDescriptor? {
    return interpretCPointer<CXModuleMapDescriptorImpl>(kniBridge34(options))
}

@ExperimentalForeignApi
fun clang_ModuleMapDescriptor_setFrameworkModuleName(arg0: CXModuleMapDescriptor?, name: String?): CXErrorCode {
    memScoped {
        return CXErrorCode.byValue(kniBridge35(arg0.rawValue, name?.cstr?.getPointer(memScope).rawValue))
    }
}
...
fun clang_ModuleMapDescriptor_setUmbrellaHeader(arg0: CXModuleMapDescriptor?, name: String?): CXErrorCode {
    memScoped {
        return CXErrorCode.byValue(kniBridge36(arg0.rawValue, name?.cstr?.getPointer(memScope).rawValue))
    }
}
...
fun clang_ModuleMapDescriptor_writeToBuffer(arg0: CXModuleMapDescriptor?, options: Int, out_buffer_ptr: CValuesRef<CPointerVar<ByteVar>>?, out_buffer_size: CValuesRef<IntVar>?): CXErrorCode {
    memScoped {
        return CXErrorCode.byValue(kniBridge37(arg0.rawValue, options, out_buffer_ptr?.getPointer(memScope).rawValue, out_buffer_size?.getPointer(memScope).rawValue))
    }
}

@ExperimentalForeignApi
fun clang_ModuleMapDescriptor_dispose(arg0: CXModuleMapDescriptor?): Unit {
    return kniBridge38(arg0.rawValue)
}
...
fun clang_getDiagnosticInSet(Diags: CXDiagnosticSet?, Index: Int): CXDiagnostic? {
    return interpretCPointer<COpaque>(kniBridge40(Diags.rawValue, Index))
}
...
fun clang_loadDiagnostics(file: String?, error: CValuesRef<CXLoadDiag_Error.Var>?, errorString: CValuesRef<CXString>?): CXDiagnosticSet? {
    memScoped {
        return interpretCPointer<COpaque>(kniBridge41(file?.cstr?.getPointer(memScope).rawValue, error?.getPointer(memScope).rawValue, errorString?.getPointer(memScope).rawValue))
    }
}

@ExperimentalForeignApi
fun clang_disposeDiagnosticSet(Diags: CXDiagnosticSet?): Unit {
    return kniBridge42(Diags.rawValue)
}

@ExperimentalForeignApi
fun clang_getChildDiagnostics(D: CXDiagnostic?): CXDiagnosticSet? {
    return interpretCPointer<COpaque>(kniBridge43(D.rawValue))
}

@ExperimentalForeignApi
fun clang_getDiagnosticFileContents(diags: CXDiagnosticSet?, file: CXFile?, outFileSize: CValuesRef<size_tVar>?): CPointer<ByteVar>? {
    memScoped {
        return interpretCPointer<ByteVar>(kniBridge44(diags.rawValue, file.rawValue, outFileSize?.getPointer(memScope).rawValue))
    }
}

@ExperimentalForeignApi
fun clang_getDiagnosticFileOriginalSourceRange(diags: CXDiagnosticSet?, file: CXFile?): CValue<CXSourceRange> {
    val kniRetVal = nativeHeap.alloc<CXSourceRange>()
    try {
        kniBridge45(diags.rawValue, file.rawValue, kniRetVal.rawPtr)
        return kniRetVal.readValue()
    } finally { nativeHeap.free(kniRetVal) }
}
...
fun clang_disposeDiagnostic(Diagnostic: CXDiagnostic?): Unit {
    return kniBridge46(Diagnostic.rawValue)
}
...
fun clang_formatDiagnostic(Diagnostic: CXDiagnostic?, Options: Int): CValue<CXString> {
    val kniRetVal = nativeHeap.alloc<CXString>()
    try {
        kniBridge47(Diagnostic.rawValue, Options, kniRetVal.rawPtr)
        return kniRetVal.readValue()
    } finally { nativeHeap.free(kniRetVal) }
}
...
fun clang_getDiagnosticSeverity(arg0: CXDiagnostic?): CXDiagnosticSeverity {
    return CXDiagnosticSeverity.byValue(kniBridge49(arg0.rawValue))
}
...
fun clang_getDiagnosticOption(Diag: CXDiagnostic?, Disable: CValuesRef<CXString>?): CValue<CXString> {
    memScoped {
        val kniRetVal = nativeHeap.alloc<CXString>()
        try {
            kniBridge52(Diag.rawValue, Disable?.getPointer(memScope).rawValue, kniRetVal.rawPtr)
            return kniRetVal.readValue()
        } finally { nativeHeap.free(kniRetVal) }
    }
}
...
fun clang_getDiagnosticCategoryName(Category: Int): CValue<CXString> {
    val kniRetVal = nativeHeap.alloc<CXString>()
    try {
        kniBridge54(Category, kniRetVal.rawPtr)
        return kniRetVal.readValue()
    } finally { nativeHeap.free(kniRetVal) }
}
...
fun clang_getDiagnosticCategoryText(arg0: CXDiagnostic?): CValue<CXString> {
    val kniRetVal = nativeHeap.alloc<CXString>()
    try {
        kniBridge55(arg0.rawValue, kniRetVal.rawPtr)
        return kniRetVal.readValue()
    } finally { nativeHeap.free(kniRetVal) }
}
...
fun clang_getDiagnosticNumRanges(arg0: CXDiagnostic?): Int {
    return kniBridge56(arg0.rawValue)
}
...
fun clang_getDiagnosticRange(Diagnostic: CXDiagnostic?, Range: Int): CValue<CXSourceRange> {
    val kniRetVal = nativeHeap.alloc<CXSourceRange>()
    try {
        kniBridge57(Diagnostic.rawValue, Range, kniRetVal.rawPtr)
        return kniRetVal.readValue()
    } finally { nativeHeap.free(kniRetVal) }
}
...
fun clang_getDiagnosticNumFixIts(Diagnostic: CXDiagnostic?): Int {
    return kniBridge58(Diagnostic.rawValue)
}
...
fun clang_getDiagnosticFixIt(Diagnostic: CXDiagnostic?, FixIt: Int, ReplacementRange: CValuesRef<CXSourceRange>?): CValue<CXString> {
    memScoped {
        val kniRetVal = nativeHeap.alloc<CXString>()
        try {
            kniBridge59(Diagnostic.rawValue, FixIt, ReplacementRange?.getPointer(memScope).rawValue, kniRetVal.rawPtr)
            return kniRetVal.readValue()
        } finally { nativeHeap.free(kniRetVal) }
    }
}
...
fun clang_createIndex(excludeDeclarationsFromPCH: Int, displayDiagnostics: Int): CXIndex? {
    return interpretCPointer<COpaque>(kniBridge60(excludeDeclarationsFromPCH, displayDiagnostics))
}

@ExperimentalForeignApi
fun clang_disposeIndex(index: CXIndex?): Unit {
    return kniBridge61(index.rawValue)
}

@ExperimentalForeignApi
fun clang_createIndexWithOptions(options: CValuesRef<CXIndexOptions>?): CXIndex? {
    memScoped {
        return interpretCPointer<COpaque>(kniBridge62(options?.getPointer(memScope).rawValue))
    }
}

@ExperimentalForeignApi
fun clang_CXIndex_setGlobalOptions(arg0: CXIndex?, options: Int): Unit {
    return kniBridge63(arg0.rawValue, options)
}

@ExperimentalForeignApi
fun clang_CXIndex_getGlobalOptions(arg0: CXIndex?): Int {
    return kniBridge64(arg0.rawValue)
}

@ExperimentalForeignApi
fun clang_CXIndex_setInvocationEmissionPathOption(arg0: CXIndex?, Path: String?): Unit {
    memScoped {
        return kniBridge65(arg0.rawValue, Path?.cstr?.getPointer(memScope).rawValue)
    }
}

@ExperimentalForeignApi
fun clang_isFileMultipleIncludeGuarded(tu: CXTranslationUnit?, file: CXFile?): Int {
    return kniBridge66(tu.rawValue, file.rawValue)
}

@ExperimentalForeignApi
fun clang_getFile(tu: CXTranslationUnit?, file_name: String?): CXFile? {
    memScoped {
        return interpretCPointer<COpaque>(kniBridge67(tu.rawValue, file_name?.cstr?.getPointer(memScope).rawValue))
    }
}
...
fun clang_getFileContents(tu: CXTranslationUnit?, file: CXFile?, size: CValuesRef<size_tVar>?): CPointer<ByteVar>? {
    memScoped {
        return interpretCPointer<ByteVar>(kniBridge68(tu.rawValue, file.rawValue, size?.getPointer(memScope).rawValue))
    }
}
...
fun clang_getLocation(tu: CXTranslationUnit?, file: CXFile?, line: Int, column: Int): CValue<CXSourceLocation> {
    val kniRetVal = nativeHeap.alloc<CXSourceLocation>()
    try {
        kniBridge69(tu.rawValue, file.rawValue, line, column, kniRetVal.rawPtr)
        return kniRetVal.readValue()
    } finally { nativeHeap.free(kniRetVal) }
}
...
fun clang_getLocationForOffset(tu: CXTranslationUnit?, file: CXFile?, offset: Int): CValue<CXSourceLocation> {
    val kniRetVal = nativeHeap.alloc<CXSourceLocation>()
    try {
        kniBridge70(tu.rawValue, file.rawValue, offset, kniRetVal.rawPtr)
        return kniRetVal.readValue()
    } finally { nativeHeap.free(kniRetVal) }
}
...
fun clang_getSkippedRanges(tu: CXTranslationUnit?, file: CXFile?): CPointer<CXSourceRangeList>? {
    return interpretCPointer<CXSourceRangeList>(kniBridge71(tu.rawValue, file.rawValue))
}

@ExperimentalForeignApi
fun clang_getAllSkippedRanges(tu: CXTranslationUnit?): CPointer<CXSourceRangeList>? {
    return interpretCPointer<CXSourceRangeList>(kniBridge72(tu.rawValue))
}

@ExperimentalForeignApi
fun clang_getNumDiagnostics(Unit: CXTranslationUnit?): Int {
    return kniBridge73(Unit.rawValue)
}

@ExperimentalForeignApi
fun clang_getDiagnostic(Unit: CXTranslationUnit?, Index: Int): CXDiagnostic? {
    return interpretCPointer<COpaque>(kniBridge74(Unit.rawValue, Index))
}

@ExperimentalForeignApi
fun clang_getDiagnosticSetFromTU(Unit: CXTranslationUnit?): CXDiagnosticSet? {
    return interpretCPointer<COpaque>(kniBridge75(Unit.rawValue))
}
...
fun clang_getTranslationUnitSpelling(CTUnit: CXTranslationUnit?): CValue<CXString> {
    val kniRetVal = nativeHeap.alloc<CXString>()
    try {
        kniBridge76(CTUnit.rawValue, kniRetVal.rawPtr)
        return kniRetVal.readValue()
    } finally { nativeHeap.free(kniRetVal) }
}
...
fun clang_createTranslationUnitFromSourceFile(CIdx: CXIndex?, source_filename: String?, num_clang_command_line_args: Int, clang_command_line_args: CValuesRef<CPointerVar<ByteVar>>?, num_unsaved_files: Int, unsaved_files: CValuesRef<CXUnsavedFile>?): CXTranslationUnit? {
    memScoped {
        return interpretCPointer<CXTranslationUnitImpl>(kniBridge77(CIdx.rawValue, source_filename?.cstr?.getPointer(memScope).rawValue, num_clang_command_line_args, clang_command_line_args?.getPointer(memScope).rawValue, num_unsaved_files, unsaved_files?.getPointer(memScope).rawValue))
    }
}
...
fun clang_createTranslationUnit(CIdx: CXIndex?, ast_filename: String?): CXTranslationUnit? {
    memScoped {
        return interpretCPointer<CXTranslationUnitImpl>(kniBridge78(CIdx.rawValue, ast_filename?.cstr?.getPointer(memScope).rawValue))
    }
}
...
fun clang_createTranslationUnit2(CIdx: CXIndex?, ast_filename: String?, out_TU: CValuesRef<CXTranslationUnitVar>?): CXErrorCode {
    memScoped {
        return CXErrorCode.byValue(kniBridge79(CIdx.rawValue, ast_filename?.cstr?.getPointer(memScope).rawValue, out_TU?.getPointer(memScope).rawValue))
    }
}
...
fun clang_parseTranslationUnit(CIdx: CXIndex?, source_filename: String?, command_line_args: CValuesRef<CPointerVar<ByteVar>>?, num_command_line_args: Int, unsaved_files: CValuesRef<CXUnsavedFile>?, num_unsaved_files: Int, options: Int): CXTranslationUnit? {
    memScoped {
        return interpretCPointer<CXTranslationUnitImpl>(kniBridge81(CIdx.rawValue, source_filename?.cstr?.getPointer(memScope).rawValue, command_line_args?.getPointer(memScope).rawValue, num_command_line_args, unsaved_files?.getPointer(memScope).rawValue, num_unsaved_files, options))
    }
}
...
fun clang_parseTranslationUnit2(CIdx: CXIndex?, source_filename: String?, command_line_args: CValuesRef<CPointerVar<ByteVar>>?, num_command_line_args: Int, unsaved_files: CValuesRef<CXUnsavedFile>?, num_unsaved_files: Int, options: Int, out_TU: CValuesRef<CXTranslationUnitVar>?): CXErrorCode {
    memScoped {
        return CXErrorCode.byValue(kniBridge82(CIdx.rawValue, source_filename?.cstr?.getPointer(memScope).rawValue, command_line_args?.getPointer(memScope).rawValue, num_command_line_args, unsaved_files?.getPointer(memScope).rawValue, num_unsaved_files, options, out_TU?.getPointer(memScope).rawValue))
    }
}
...
fun clang_parseTranslationUnit2FullArgv(CIdx: CXIndex?, source_filename: String?, command_line_args: CValuesRef<CPointerVar<ByteVar>>?, num_command_line_args: Int, unsaved_files: CValuesRef<CXUnsavedFile>?, num_unsaved_files: Int, options: Int, out_TU: CValuesRef<CXTranslationUnitVar>?): CXErrorCode {
    memScoped {
        return CXErrorCode.byValue(kniBridge83(CIdx.rawValue, source_filename?.cstr?.getPointer(memScope).rawValue, command_line_args?.getPointer(memScope).rawValue, num_command_line_args, unsaved_files?.getPointer(memScope).rawValue, num_unsaved_files, options, out_TU?.getPointer(memScope).rawValue))
    }
}

@ExperimentalForeignApi
fun clang_defaultSaveOptions(TU: CXTranslationUnit?): Int {
    return kniBridge84(TU.rawValue)
}

@ExperimentalForeignApi
fun clang_saveTranslationUnit(TU: CXTranslationUnit?, FileName: String?, options: Int): Int {
    memScoped {
        return kniBridge85(TU.rawValue, FileName?.cstr?.getPointer(memScope).rawValue, options)
    }
}

@ExperimentalForeignApi
fun clang_suspendTranslationUnit(arg0: CXTranslationUnit?): Int {
    return kniBridge86(arg0.rawValue)
}

@ExperimentalForeignApi
fun clang_disposeTranslationUnit(arg0: CXTranslationUnit?): Unit {
    return kniBridge87(arg0.rawValue)
}

@ExperimentalForeignApi
fun clang_defaultReparseOptions(TU: CXTranslationUnit?): Int {
    return kniBridge88(TU.rawValue)
}
...
fun clang_reparseTranslationUnit(TU: CXTranslationUnit?, num_unsaved_files: Int, unsaved_files: CValuesRef<CXUnsavedFile>?, options: Int): Int {
    memScoped {
        return kniBridge89(TU.rawValue, num_unsaved_files, unsaved_files?.getPointer(memScope).rawValue, options)
    }
}

@ExperimentalForeignApi
fun clang_getTUResourceUsageName(kind: CXTUResourceUsageKind): CPointer<ByteVar>? {
    return interpretCPointer<ByteVar>(kniBridge90(kind.value))
}
...
fun clang_getCXTUResourceUsage(TU: CXTranslationUnit?): CValue<CXTUResourceUsage> {
    ...
    try {
        kniBridge91(TU.rawValue, kniRetVal.rawPtr)
        return kniRetVal.readValue()
    } finally { nativeHeap.free(kniRetVal) }
}
...
fun clang_disposeCXTUResourceUsage(usage: CValue<CXTUResourceUsage>): Unit {
    memScoped {
        return kniBridge92(usage.getPointer(memScope).rawValue)
    }
}

@ExperimentalForeignApi
fun clang_getTranslationUnitTargetInfo(CTUnit: CXTranslationUnit?): CXTargetInfo? {
    return interpretCPointer<CXTargetInfoImpl>(kniBridge93(CTUnit.rawValue))
}

@ExperimentalForeignApi
fun clang_TargetInfo_dispose(Info: CXTargetInfo?): Unit {
    return kniBridge94(Info.rawValue)
}
...
fun clang_TargetInfo_getTriple(Info: CXTargetInfo?): CValue<CXString> {
    val kniRetVal = nativeHeap.alloc<CXString>()
    try {
        kniBridge95(Info.rawValue, kniRetVal.rawPtr)
        return kniRetVal.readValue()
    } finally { nativeHeap.free(kniRetVal) }
}
...
fun clang_TargetInfo_getPointerWidth(Info: CXTargetInfo?): Int {
    return kniBridge96(Info.rawValue)
}
...
fun clang_getTranslationUnitCursor(arg0: CXTranslationUnit?): CValue<CXCursor> {
    val kniRetVal = nativeHeap.alloc<CXCursor>()
    try {
        kniBridge98(arg0.rawValue, kniRetVal.rawPtr)
        return kniRetVal.readValue()
    } finally { nativeHeap.free(kniRetVal) }
}
...
fun clang_equalCursors(arg0: CValue<CXCursor>, arg1: CValue<CXCursor>): Int {
    memScoped {
        return kniBridge99(arg0.getPointer(memScope).rawValue, arg1.getPointer(memScope).rawValue)
    }
}
...
fun clang_Cursor_isNull(cursor: CValue<CXCursor>): Int {
    memScoped {
        return kniBridge100(cursor.getPointer(memScope).rawValue)
    }
}
...
fun clang_getCursorKind(arg0: CValue<CXCursor>): CXCursorKind {
    memScoped {
        return CXCursorKind.byValue(kniBridge102(arg0.getPointer(memScope).rawValue))
    }
}
...
fun clang_Cursor_hasAttrs(C: CValue<CXCursor>): Int {
    memScoped {
        return kniBridge109(C.getPointer(memScope).rawValue)
    }
}
...
fun clang_isTranslationUnit(arg0: CXCursorKind): Int {
    return kniBridge111(arg0.value)
}

@ExperimentalForeignApi
fun clang_isPreprocessing(arg0: CXCursorKind): Int {
    return kniBridge112(arg0.value)
}

@ExperimentalForeignApi
fun clang_isUnexposed(arg0: CXCursorKind): Int {
    return kniBridge113(arg0.value)
}

@ExperimentalForeignApi
fun clang_getCursorLinkage(cursor: CValue<CXCursor>): CXLinkageKind {
    memScoped {
        return CXLinkageKind.byValue(kniBridge114(cursor.getPointer(memScope).rawValue))
    }
}
...
fun clang_getCursorVisibility(cursor: CValue<CXCursor>): CXVisibilityKind {
    memScoped {
        return CXVisibilityKind.byValue(kniBridge115(cursor.getPointer(memScope).rawValue))
    }
}
...
fun clang_getCursorAvailability(cursor: CValue<CXCursor>): CXAvailabilityKind {
    memScoped {
        return CXAvailabilityKind.byValue(kniBridge116(cursor.getPointer(memScope).rawValue))
    }
}
...
fun clang_getCursorPlatformAvailability(cursor: CValue<CXCursor>, always_deprecated: CValuesRef<IntVar>?, deprecated_message: CValuesRef<CXString>?, always_unavailable: CValuesRef<IntVar>?, unavailable_message: CValuesRef<CXString>?, availability: CValuesRef<CXPlatformAvailability>?, availability_size: Int): Int {
    memScoped {
        return kniBridge117(cursor.getPointer(memScope).rawValue, always_deprecated?.getPointer(memScope).rawValue, deprecated_message?.getPointer(memScope).rawValue, always_unavailable?.getPointer(memScope).rawValue, unavailable_message?.getPointer(memScope).rawValue, availability?.getPointer(memScope).rawValue, availability_size)
    }
}
...
fun clang_disposeCXPlatformAvailability(availability: CValuesRef<CXPlatformAvailability>?): Unit {
    memScoped {
        return kniBridge118(availability?.getPointer(memScope).rawValue)
    }
}
...
fun clang_Cursor_hasVarDeclExternalStorage(cursor: CValue<CXCursor>): Int {
    memScoped {
        return kniBridge121(cursor.getPointer(memScope).rawValue)
    }
}
...
fun clang_getCursorLanguage(cursor: CValue<CXCursor>): CXLanguageKind {
    memScoped {
        return CXLanguageKind.byValue(kniBridge122(cursor.getPointer(memScope).rawValue))
    }
}
...
fun clang_getCursorTLSKind(cursor: CValue<CXCursor>): CXTLSKind {
    memScoped {
        return kniBridge123(cursor.getPointer(memScope).rawValue)
    }
}
...
fun clang_Cursor_getTranslationUnit(arg0: CValue<CXCursor>): CXTranslationUnit? {
    memScoped {
        return interpretCPointer<CXTranslationUnitImpl>(kniBridge124(arg0.getPointer(memScope).rawValue))
    }
}

@ExperimentalForeignApi
fun clang_createCXCursorSet(): CXCursorSet? {
    return interpretCPointer<CXCursorSetImpl>(kniBridge125())
}

@ExperimentalForeignApi
fun clang_disposeCXCursorSet(cset: CXCursorSet?): Unit {
    return kniBridge126(cset.rawValue)
}

@ExperimentalForeignApi
fun clang_CXCursorSet_contains(cset: CXCursorSet?, cursor: CValue<CXCursor>): Int {
    memScoped {
        return kniBridge127(cset.rawValue, cursor.getPointer(memScope).rawValue)
    }
}
...
fun clang_CXCursorSet_insert(cset: CXCursorSet?, cursor: CValue<CXCursor>): Int {
    memScoped {
        return kniBridge128(cset.rawValue, cursor.getPointer(memScope).rawValue)
    }
}
...
fun clang_getCursorSemanticParent(cursor: CValue<CXCursor>): CValue<CXCursor> {
    memScoped {
        val kniRetVal = nativeHeap.alloc<CXCursor>()
        try {
            kniBridge129(cursor.getPointer(memScope).rawValue, kniRetVal.rawPtr)
            return kniRetVal.readValue()
        } finally { nativeHeap.free(kniRetVal) }
    }
}
...
fun clang_getCursorLexicalParent(cursor: CValue<CXCursor>): CValue<CXCursor> {
    memScoped {
        val kniRetVal = nativeHeap.alloc<CXCursor>()
        try {
            kniBridge130(cursor.getPointer(memScope).rawValue, kniRetVal.rawPtr)
            return kniRetVal.readValue()
        } finally { nativeHeap.free(kniRetVal) }
    }
}
...
fun clang_getOverriddenCursors(cursor: CValue<CXCursor>, overridden: CValuesRef<CPointerVar<CXCursor>>?, num_overridden: CValuesRef<IntVar>?): Unit {
    memScoped {
        return kniBridge131(cursor.getPointer(memScope).rawValue, overridden?.getPointer(memScope).rawValue, num_overridden?.getPointer(memScope).rawValue)
    }
}
...
fun clang_disposeOverriddenCursors(overridden: CValuesRef<CXCursor>?): Unit {
    memScoped {
        return kniBridge132(overridden?.getPointer(memScope).rawValue)
    }
}
...
fun clang_getIncludedFile(cursor: CValue<CXCursor>): CXFile? {
    memScoped {
        return interpretCPointer<COpaque>(kniBridge133(cursor.getPointer(memScope).rawValue))
    }
}
...
fun clang_getCursor(arg0: CXTranslationUnit?, arg1: CValue<CXSourceLocation>): CValue<CXCursor> {
    memScoped {
        val kniRetVal = nativeHeap.alloc<CXCursor>()
        try {
            kniBridge134(arg0.rawValue, arg1.getPointer(memScope).rawValue, kniRetVal.rawPtr)
            return kniRetVal.readValue()
        } finally { nativeHeap.free(kniRetVal) }
    }
}
...
fun clang_getCursorLocation(arg0: CValue<CXCursor>): CValue<CXSourceLocation> {
    memScoped {
        val kniRetVal = nativeHeap.alloc<CXSourceLocation>()
        try {
            kniBridge135(arg0.getPointer(memScope).rawValue, kniRetVal.rawPtr)
            return kniRetVal.readValue()
        } finally { nativeHeap.free(kniRetVal) }
    }
}
...
fun clang_getCursorExtent(arg0: CValue<CXCursor>): CValue<CXSourceRange> {
    memScoped {
        val kniRetVal = nativeHeap.alloc<CXSourceRange>()
        try {
            kniBridge136(arg0.getPointer(memScope).rawValue, kniRetVal.rawPtr)
            return kniRetVal.readValue()
        } finally { nativeHeap.free(kniRetVal) }
    }
}
...
fun clang_getTypeSpelling(CT: CValue<CXType>): CValue<CXString> {
    memScoped {
        val kniRetVal = nativeHeap.alloc<CXString>()
        try {
            kniBridge138(CT.getPointer(memScope).rawValue, kniRetVal.rawPtr)
            return kniRetVal.readValue()
        } finally { nativeHeap.free(kniRetVal) }
    }
}
...
fun clang_getTypedefDeclUnderlyingType(C: CValue<CXCursor>): CValue<CXType> {
    memScoped {
        val kniRetVal = nativeHeap.alloc<CXType>()
        try {
            kniBridge139(C.getPointer(memScope).rawValue, kniRetVal.rawPtr)
            return kniRetVal.readValue()
        } finally { nativeHeap.free(kniRetVal) }
    }
}
...
fun clang_getEnumDeclIntegerType(C: CValue<CXCursor>): CValue<CXType> {
    memScoped {
        val kniRetVal = nativeHeap.alloc<CXType>()
        try {
            kniBridge140(C.getPointer(memScope).rawValue, kniRetVal.rawPtr)
            return kniRetVal.readValue()
        } finally { nativeHeap.free(kniRetVal) }
    }
}
...
fun clang_Cursor_getTemplateArgumentKind(C: CValue<CXCursor>, I: Int): CXTemplateArgumentKind {
    memScoped {
        return CXTemplateArgumentKind.byValue(kniBridge148(C.getPointer(memScope).rawValue, I))
    }
}
...
fun clang_Cursor_getTemplateArgumentType(C: CValue<CXCursor>, I: Int): CValue<CXType> {
    memScoped {
        val kniRetVal = nativeHeap.alloc<CXType>()
        try {
            kniBridge149(C.getPointer(memScope).rawValue, I, kniRetVal.rawPtr)
            return kniRetVal.readValue()
        } finally { nativeHeap.free(kniRetVal) }
    }
}
...
fun clang_Cursor_getTemplateArgumentValue(C: CValue<CXCursor>, I: Int): Long {
    memScoped {
        return kniBridge150(C.getPointer(memScope).rawValue, I)
    }
}
...
fun clang_Cursor_getTemplateArgumentUnsignedValue(C: CValue<CXCursor>, I: Int): Long {
    memScoped {
        return kniBridge151(C.getPointer(memScope).rawValue, I)
    }
}
...
fun clang_equalTypes(A: CValue<CXType>, B: CValue<CXType>): Int {
    memScoped {
        return kniBridge152(A.getPointer(memScope).rawValue, B.getPointer(memScope).rawValue)
    }
}
...
fun clang_Cursor_isMacroFunctionLike(C: CValue<CXCursor>): Int {
    memScoped {
        return kniBridge155(C.getPointer(memScope).rawValue)
    }
}
...
fun clang_Cursor_isMacroBuiltin(C: CValue<CXCursor>): Int {
    memScoped {
        return kniBridge156(C.getPointer(memScope).rawValue)
    }
}
...
fun clang_Cursor_isFunctionInlined(C: CValue<CXCursor>): Int {
    memScoped {
        return kniBridge157(C.getPointer(memScope).rawValue)
    }
}
...
fun clang_getUnqualifiedType(CT: CValue<CXType>): CValue<CXType> {
    memScoped {
        val kniRetVal = nativeHeap.alloc<CXType>()
        try {
            kniBridge163(CT.getPointer(memScope).rawValue, kniRetVal.rawPtr)
            return kniRetVal.readValue()
        } finally { nativeHeap.free(kniRetVal) }
    }
}
...
fun clang_getNonReferenceType(CT: CValue<CXType>): CValue<CXType> {
    memScoped {
        val kniRetVal = nativeHeap.alloc<CXType>()
        try {
            kniBridge164(CT.getPointer(memScope).rawValue, kniRetVal.rawPtr)
            return kniRetVal.readValue()
        } finally { nativeHeap.free(kniRetVal) }
    }
}
...
fun clang_getDeclObjCTypeEncoding(C: CValue<CXCursor>): CValue<CXString> {
    memScoped {
        val kniRetVal = nativeHeap.alloc<CXString>()
        try {
            kniBridge166(C.getPointer(memScope).rawValue, kniRetVal.rawPtr)
            return kniRetVal.readValue()
        } finally { nativeHeap.free(kniRetVal) }
    }
}
...
fun clang_Type_getObjCEncoding(type: CValue<CXType>): CValue<CXString> {
    memScoped {
        val kniRetVal = nativeHeap.alloc<CXString>()
        try {
            kniBridge167(type.getPointer(memScope).rawValue, kniRetVal.rawPtr)
            return kniRetVal.readValue()
        } finally { nativeHeap.free(kniRetVal) }
    }
}
...
fun clang_getTypeKindSpelling(K: CXTypeKind): CValue<CXString> {
    val kniRetVal = nativeHeap.alloc<CXString>()
    try {
        kniBridge168(K.value, kniRetVal.rawPtr)
        return kniRetVal.readValue()
    } finally { nativeHeap.free(kniRetVal) }
}
...
fun clang_getFunctionTypeCallingConv(T: CValue<CXType>): CXCallingConv {
    memScoped {
        return CXCallingConv.byValue(kniBridge169(T.getPointer(memScope).rawValue))
    }
}
...
fun clang_getResultType(T: CValue<CXType>): CValue<CXType> {
    memScoped {
        val kniRetVal = nativeHeap.alloc<CXType>()
        try {
            kniBridge170(T.getPointer(memScope).rawValue, kniRetVal.rawPtr)
            return kniRetVal.readValue()
        } finally { nativeHeap.free(kniRetVal) }
    }
}
...
fun clang_getExceptionSpecificationType(T: CValue<CXType>): Int {
    memScoped {
        return kniBridge171(T.getPointer(memScope).rawValue)
    }
}
...
fun clang_Type_getObjCProtocolDecl(T: CValue<CXType>, i: Int): CValue<CXCursor> {
    memScoped {
        val kniRetVal = nativeHeap.alloc<CXCursor>()
        try {
            kniBridge176(T.getPointer(memScope).rawValue, i, kniRetVal.rawPtr)
            return kniRetVal.readValue()
        } finally { nativeHeap.free(kniRetVal) }
    }
}
...
fun clang_Type_getObjCTypeArg(T: CValue<CXType>, i: Int): CValue<CXType> {
    memScoped {
        val kniRetVal = nativeHeap.alloc<CXType>()
        try {
            kniBridge178(T.getPointer(memScope).rawValue, i, kniRetVal.rawPtr)
            return kniRetVal.readValue()
        } finally { nativeHeap.free(kniRetVal) }
    }
}
...
fun clang_getCursorResultType(C: CValue<CXCursor>): CValue<CXType> {
    memScoped {
        val kniRetVal = nativeHeap.alloc<CXType>()
        try {
            kniBridge180(C.getPointer(memScope).rawValue, kniRetVal.rawPtr)
            return kniRetVal.readValue()
        } finally { nativeHeap.free(kniRetVal) }
    }
}
...
fun clang_getCursorExceptionSpecificationType(C: CValue<CXCursor>): Int {
    memScoped {
        return kniBridge181(C.getPointer(memScope).rawValue)
    }
}
...
fun clang_getElementType(T: CValue<CXType>): CValue<CXType> {
    memScoped {
        val kniRetVal = nativeHeap.alloc<CXType>()
        try {
            kniBridge183(T.getPointer(memScope).rawValue, kniRetVal.rawPtr)
            return kniRetVal.readValue()
        } finally { nativeHeap.free(kniRetVal) }
    }
}
...
fun clang_Type_getOffsetOf(T: CValue<CXType>, S: String?): Long {
    memScoped {
        return kniBridge193(T.getPointer(memScope).rawValue, S?.cstr?.getPointer(memScope).rawValue)
    }
}
...
fun clang_Type_getModifiedType(T: CValue<CXType>): CValue<CXType> {
    memScoped {
        val kniRetVal = nativeHeap.alloc<CXType>()
        try {
            kniBridge194(T.getPointer(memScope).rawValue, kniRetVal.rawPtr)
            return kniRetVal.readValue()
        } finally { nativeHeap.free(kniRetVal) }
    }
}
...
fun clang_Type_getValueType(CT: CValue<CXType>): CValue<CXType> {
    memScoped {
        val kniRetVal = nativeHeap.alloc<CXType>()
        try {
            kniBridge195(CT.getPointer(memScope).rawValue, kniRetVal.rawPtr)
            return kniRetVal.readValue()
        } finally { nativeHeap.free(kniRetVal) }
    }
}
...
fun clang_Cursor_isAnonymous(C: CValue<CXCursor>): Int {
    memScoped {
        return kniBridge197(C.getPointer(memScope).rawValue)
    }
}
...
fun clang_Cursor_isAnonymousRecordDecl(C: CValue<CXCursor>): Int {
    memScoped {
        return kniBridge198(C.getPointer(memScope).rawValue)
    }
}
...
fun clang_Type_getNumTemplateArguments(T: CValue<CXType>): Int {
    memScoped {
        return kniBridge200(T.getPointer(memScope).rawValue)
    }
}
...
fun clang_Type_getTemplateArgumentAsType(T: CValue<CXType>, i: Int): CValue<CXType> {
    memScoped {
        val kniRetVal = nativeHeap.alloc<CXType>()
        try {
            kniBridge201(T.getPointer(memScope).rawValue, i, kniRetVal.rawPtr)
            return kniRetVal.readValue()
        } finally { nativeHeap.free(kniRetVal) }
    }
}
...
fun clang_Type_getCXXRefQualifier(T: CValue<CXType>): CXRefQualifierKind {
    memScoped {
        return kniBridge202(T.getPointer(memScope).rawValue)
    }
}
...
fun clang_isVirtualBase(arg0: CValue<CXCursor>): Int {
    memScoped {
        return kniBridge203(arg0.getPointer(memScope).rawValue)
    }
}
...
fun clang_getCXXAccessSpecifier(arg0: CValue<CXCursor>): CX_CXXAccessSpecifier {
    memScoped {
        return CX_CXXAccessSpecifier.byValue(kniBridge204(arg0.getPointer(memScope).rawValue))
    }
}
...
fun clang_constructUSR_ObjCClass(class_name: String?): CValue<CXString> {
    memScoped {
        val kniRetVal = nativeHeap.alloc<CXString>()
        try {
            kniBridge211(class_name?.cstr?.getPointer(memScope).rawValue, kniRetVal.rawPtr)
            return kniRetVal.readValue()
        } finally { nativeHeap.free(kniRetVal) }
    }
}
...
fun clang_constructUSR_ObjCCategory(class_name: String?, category_name: String?): CValue<CXString> {
    memScoped {
        val kniRetVal = nativeHeap.alloc<CXString>()
        try {
            kniBridge212(class_name?.cstr?.getPointer(memScope).rawValue, category_name?.cstr?.getPointer(memScope).rawValue, kniRetVal.rawPtr)
            return kniRetVal.readValue()
        } finally { nativeHeap.free(kniRetVal) }
    }
}
...
fun clang_constructUSR_ObjCProtocol(protocol_name: String?): CValue<CXString> {
    memScoped {
        val kniRetVal = nativeHeap.alloc<CXString>()
        try {
            kniBridge213(protocol_name?.cstr?.getPointer(memScope).rawValue, kniRetVal.rawPtr)
            return kniRetVal.readValue()
        } finally { nativeHeap.free(kniRetVal) }
    }
}
...
fun clang_constructUSR_ObjCIvar(name: String?, classUSR: CValue<CXString>): CValue<CXString> {
    memScoped {
        val kniRetVal = nativeHeap.alloc<CXString>()
        try {
            kniBridge214(name?.cstr?.getPointer(memScope).rawValue, classUSR.getPointer(memScope).rawValue, kniRetVal.rawPtr)
            return kniRetVal.readValue()
        } finally { nativeHeap.free(kniRetVal) }
    }
}
...
fun clang_constructUSR_ObjCMethod(name: String?, isInstanceMethod: Int, classUSR: CValue<CXString>): CValue<CXString> {
    memScoped {
        val kniRetVal = nativeHeap.alloc<CXString>()
        try {
            kniBridge215(name?.cstr?.getPointer(memScope).rawValue, isInstanceMethod, classUSR.getPointer(memScope).rawValue, kniRetVal.rawPtr)
            return kniRetVal.readValue()
        } finally { nativeHeap.free(kniRetVal) }
    }
}
...
fun clang_constructUSR_ObjCProperty(property: String?, classUSR: CValue<CXString>): CValue<CXString> {
    memScoped {
        val kniRetVal = nativeHeap.alloc<CXString>()
        try {
            kniBridge216(property?.cstr?.getPointer(memScope).rawValue, classUSR.getPointer(memScope).rawValue, kniRetVal.rawPtr)
            return kniRetVal.readValue()
        } finally { nativeHeap.free(kniRetVal) }
    }
}
...
fun clang_Cursor_getSpellingNameRange(arg0: CValue<CXCursor>, pieceIndex: Int, options: Int): CValue<CXSourceRange> {
    memScoped {
        val kniRetVal = nativeHeap.alloc<CXSourceRange>()
        try {
            kniBridge218(arg0.getPointer(memScope).rawValue, pieceIndex, options, kniRetVal.rawPtr)
            return kniRetVal.readValue()
        } finally { nativeHeap.free(kniRetVal) }
    }
}
...
fun clang_getCursorPrettyPrinted(Cursor: CValue<CXCursor>, Policy: CXPrintingPolicy?): CValue<CXString> {
    memScoped {
        val kniRetVal = nativeHeap.alloc<CXString>()
        try {
            kniBridge223(Cursor.getPointer(memScope).rawValue, Policy.rawValue, kniRetVal.rawPtr)
            return kniRetVal.readValue()
        } finally { nativeHeap.free(kniRetVal) }
    }
}
...
fun clang_Cursor_getObjCSelectorIndex(arg0: CValue<CXCursor>): Int {
    memScoped {
        return kniBridge229(arg0.getPointer(memScope).rawValue)
    }
}
...
fun clang_Cursor_getObjCPropertyAttributes(C: CValue<CXCursor>, reserved: Int): Int {
    memScoped {
        return kniBridge232(C.getPointer(memScope).rawValue, reserved)
    }
}
...
fun clang_Cursor_isObjCOptional(C: CValue<CXCursor>): Int {
    memScoped {
        return kniBridge236(C.getPointer(memScope).rawValue)
    }
}
...
fun clang_Cursor_isVariadic(C: CValue<CXCursor>): Int {
    memScoped {
        return kniBridge237(C.getPointer(memScope).rawValue)
    }
}
...
fun clang_Cursor_isExternalSymbol(C: CValue<CXCursor>, language: CValuesRef<CXString>?, definedIn: CValuesRef<CXString>?, isGenerated: CValuesRef<IntVar>?): Int {
    memScoped {
        return kniBridge238(C.getPointer(memScope).rawValue, language?.getPointer(memScope).rawValue, definedIn?.getPointer(memScope).rawValue, isGenerated?.getPointer(memScope).rawValue)
    }
}
...
fun clang_Cursor_getRawCommentText(C: CValue<CXCursor>): CValue<CXString> {
    memScoped {
        val kniRetVal = nativeHeap.alloc<CXString>()
        try {
            kniBridge240(C.getPointer(memScope).rawValue, kniRetVal.rawPtr)
            return kniRetVal.readValue()
        } finally { nativeHeap.free(kniRetVal) }
    }
}
...
fun clang_Cursor_getBriefCommentText(C: CValue<CXCursor>): CValue<CXString> {
    memScoped {
        val kniRetVal = nativeHeap.alloc<CXString>()
        try {
            kniBridge241(C.getPointer(memScope).rawValue, kniRetVal.rawPtr)
            return kniRetVal.readValue()
        } finally { nativeHeap.free(kniRetVal) }
    }
}
...
fun clang_Cursor_getMangling(arg0: CValue<CXCursor>): CValue<CXString> {
    memScoped {
        val kniRetVal = nativeHeap.alloc<CXString>()
        try {
            kniBridge242(arg0.getPointer(memScope).rawValue, kniRetVal.rawPtr)
            return kniRetVal.readValue()
        } finally { nativeHeap.free(kniRetVal) }
    }
}
...
fun clang_Cursor_getCXXManglings(arg0: CValue<CXCursor>): CPointer<CXStringSet>? {
    memScoped {
        return interpretCPointer<CXStringSet>(kniBridge243(arg0.getPointer(memScope).rawValue))
    }
}
...
fun clang_Cursor_getObjCManglings(arg0: CValue<CXCursor>): CPointer<CXStringSet>? {
    memScoped {
        return interpretCPointer<CXStringSet>(kniBridge244(arg0.getPointer(memScope).rawValue))
    }
}
...
fun clang_Cursor_getModule(C: CValue<CXCursor>): CXModule? {
    memScoped {
        return interpretCPointer<COpaque>(kniBridge245(C.getPointer(memScope).rawValue))
    }
}

@ExperimentalForeignApi
fun clang_getModuleForFile(arg0: CXTranslationUnit?, arg1: CXFile?): CXModule? {
    return interpretCPointer<COpaque>(kniBridge246(arg0.rawValue, arg1.rawValue))
}

@ExperimentalForeignApi
fun clang_Module_getASTFile(Module: CXModule?): CXFile? {
    return interpretCPointer<COpaque>(kniBridge247(Module.rawValue))
}

@ExperimentalForeignApi
fun clang_Module_getParent(Module: CXModule?): CXModule? {
    return interpretCPointer<COpaque>(kniBridge248(Module.rawValue))
}
...
fun clang_Module_getName(Module: CXModule?): CValue<CXString> {
    val kniRetVal = nativeHeap.alloc<CXString>()
    try {
        kniBridge249(Module.rawValue, kniRetVal.rawPtr)
        return kniRetVal.readValue()
    } finally { nativeHeap.free(kniRetVal) }
}
...
fun clang_Module_getFullName(Module: CXModule?): CValue<CXString> {
    val kniRetVal = nativeHeap.alloc<CXString>()
    try {
        kniBridge250(Module.rawValue, kniRetVal.rawPtr)
        return kniRetVal.readValue()
    } finally { nativeHeap.free(kniRetVal) }
}
...
@ExperimentalForeignApi
fun clang_CXXMethod_isCopyAssignmentOperator(C: CValue<CXCursor>): Int {
    memScoped {
...
@ExperimentalForeignApi
fun clang_CXXMethod_isMoveAssignmentOperator(C: CValue<CXCursor>): Int {
    memScoped {
...
fun clang_getTemplateCursorKind(C: CValue<CXCursor>): CXCursorKind {
    memScoped {
        return CXCursorKind.byValue(kniBridge270(C.getPointer(memScope).rawValue))
    }
}
...
fun clang_getSpecializedCursorTemplate(C: CValue<CXCursor>): CValue<CXCursor> {
    memScoped {
        val kniRetVal = nativeHeap.alloc<CXCursor>()
        try {
            kniBridge271(C.getPointer(memScope).rawValue, kniRetVal.rawPtr)
            return kniRetVal.readValue()
        } finally { nativeHeap.free(kniRetVal) }
    }
}
...
fun clang_getCursorReferenceNameRange(C: CValue<CXCursor>, NameFlags: Int, PieceIndex: Int): CValue<CXSourceRange> {
    memScoped {
        val kniRetVal = nativeHeap.alloc<CXSourceRange>()
        try {
            kniBridge272(C.getPointer(memScope).rawValue, NameFlags, PieceIndex, kniRetVal.rawPtr)
            return kniRetVal.readValue()
        } finally { nativeHeap.free(kniRetVal) }
    }
}
...
fun clang_getToken(TU: CXTranslationUnit?, Location: CValue<CXSourceLocation>): CPointer<CXToken>? {
    memScoped {
        return interpretCPointer<CXToken>(kniBridge273(TU.rawValue, Location.getPointer(memScope).rawValue))
    }
}
...
fun clang_getTokenKind(arg0: CValue<CXToken>): CXTokenKind {
    memScoped {
        return CXTokenKind.byValue(kniBridge274(arg0.getPointer(memScope).rawValue))
    }
}
...
fun clang_getTokenSpelling(arg0: CXTranslationUnit?, arg1: CValue<CXToken>): CValue<CXString> {
    memScoped {
        val kniRetVal = nativeHeap.alloc<CXString>()
        try {
            kniBridge275(arg0.rawValue, arg1.getPointer(memScope).rawValue, kniRetVal.rawPtr)
            return kniRetVal.readValue()
        } finally { nativeHeap.free(kniRetVal) }
    }
}
...
fun clang_getTokenLocation(arg0: CXTranslationUnit?, arg1: CValue<CXToken>): CValue<CXSourceLocation> {
    memScoped {
        val kniRetVal = nativeHeap.alloc<CXSourceLocation>()
        try {
            kniBridge276(arg0.rawValue, arg1.getPointer(memScope).rawValue, kniRetVal.rawPtr)
            return kniRetVal.readValue()
        } finally { nativeHeap.free(kniRetVal) }
    }
}
...
fun clang_getTokenExtent(arg0: CXTranslationUnit?, arg1: CValue<CXToken>): CValue<CXSourceRange> {
    memScoped {
        val kniRetVal = nativeHeap.alloc<CXSourceRange>()
        try {
            kniBridge277(arg0.rawValue, arg1.getPointer(memScope).rawValue, kniRetVal.rawPtr)
            return kniRetVal.readValue()
        } finally { nativeHeap.free(kniRetVal) }
    }
}
...
fun clang_tokenize(TU: CXTranslationUnit?, Range: CValue<CXSourceRange>, Tokens: CValuesRef<CPointerVar<CXToken>>?, NumTokens: CValuesRef<IntVar>?): Unit {
    memScoped {
        return kniBridge278(TU.rawValue, Range.getPointer(memScope).rawValue, Tokens?.getPointer(memScope).rawValue, NumTokens?.getPointer(memScope).rawValue)
    }
}
...
fun clang_annotateTokens(TU: CXTranslationUnit?, Tokens: CValuesRef<CXToken>?, NumTokens: Int, Cursors: CValuesRef<CXCursor>?): Unit {
    memScoped {
        return kniBridge279(TU.rawValue, Tokens?.getPointer(memScope).rawValue, NumTokens, Cursors?.getPointer(memScope).rawValue)
    }
}
...
fun clang_disposeTokens(TU: CXTranslationUnit?, Tokens: CValuesRef<CXToken>?, NumTokens: Int): Unit {
    memScoped {
        return kniBridge280(TU.rawValue, Tokens?.getPointer(memScope).rawValue, NumTokens)
    }
}
...
fun clang_getCursorKindSpelling(Kind: CXCursorKind): CValue<CXString> {
    val kniRetVal = nativeHeap.alloc<CXString>()
    try {
        kniBridge281(Kind.value, kniRetVal.rawPtr)
        return kniRetVal.readValue()
    } finally { nativeHeap.free(kniRetVal) }
}
...
fun clang_getDefinitionSpellingAndExtent(arg0: CValue<CXCursor>, startBuf: CValuesRef<CPointerVar<ByteVar>>?, endBuf: CValuesRef<CPointerVar<ByteVar>>?, startLine: CValuesRef<IntVar>?, startColumn: CValuesRef<IntVar>?, endLine: CValuesRef<IntVar>?, endColumn: CValuesRef<IntVar>?): Unit {
    memScoped {
        return kniBridge282(arg0.getPointer(memScope).rawValue, startBuf?.getPointer(memScope).rawValue, endBuf?.getPointer(memScope).rawValue, startLine?.getPointer(memScope).rawValue, startColumn?.getPointer(memScope).rawValue, endLine?.getPointer(memScope).rawValue, endColumn?.getPointer(memScope).rawValue)
    }
}
...
fun clang_executeOnThread(fn: CPointer<CFunction<(COpaquePointer?) -> Unit>>?, user_data: CValuesRef<*>?, stack_size: Int): Unit {
    memScoped {
        return kniBridge284(fn.rawValue, user_data?.getPointer(memScope).rawValue, stack_size)
    }
}

@ExperimentalForeignApi
fun clang_getCompletionChunkKind(completion_string: CXCompletionString?, chunk_number: Int): CXCompletionChunkKind {
    return CXCompletionChunkKind.byValue(kniBridge285(completion_string.rawValue, chunk_number))
}
...
fun clang_getCompletionChunkText(completion_string: CXCompletionString?, chunk_number: Int): CValue<CXString> {
    val kniRetVal = nativeHeap.alloc<CXString>()
    try {
        kniBridge286(completion_string.rawValue, chunk_number, kniRetVal.rawPtr)
        return kniRetVal.readValue()
    } finally { nativeHeap.free(kniRetVal) }
}
...
fun clang_getCompletionAnnotation(completion_string: CXCompletionString?, annotation_number: Int): CValue<CXString> {
    val kniRetVal = nativeHeap.alloc<CXString>()
    try {
        kniBridge292(completion_string.rawValue, annotation_number, kniRetVal.rawPtr)
        return kniRetVal.readValue()
    } finally { nativeHeap.free(kniRetVal) }
}
...
fun clang_getCompletionParent(completion_string: CXCompletionString?, kind: CValuesRef<CXCursorKind.Var>?): CValue<CXString> {
    memScoped {
        val kniRetVal = nativeHeap.alloc<CXString>()
        try {
            kniBridge293(completion_string.rawValue, kind?.getPointer(memScope).rawValue, kniRetVal.rawPtr)
            return kniRetVal.readValue()
        } finally { nativeHeap.free(kniRetVal) }
    }
}
...
fun clang_getCompletionBriefComment(completion_string: CXCompletionString?): CValue<CXString> {
    val kniRetVal = nativeHeap.alloc<CXString>()
    try {
        kniBridge294(completion_string.rawValue, kniRetVal.rawPtr)
        return kniRetVal.readValue()
    } finally { nativeHeap.free(kniRetVal) }
}
...
fun clang_getCursorCompletionString(cursor: CValue<CXCursor>): CXCompletionString? {
    memScoped {
        return interpretCPointer<COpaque>(kniBridge295(cursor.getPointer(memScope).rawValue))
    }
}
...
fun clang_getCompletionNumFixIts(results: CValuesRef<CXCodeCompleteResults>?, completion_index: Int): Int {
    memScoped {
        return kniBridge296(results?.getPointer(memScope).rawValue, completion_index)
    }
}
...
fun clang_getCompletionFixIt(results: CValuesRef<CXCodeCompleteResults>?, completion_index: Int, fixit_index: Int, replacement_range: CValuesRef<CXSourceRange>?): CValue<CXString> {
    memScoped {
        val kniRetVal = nativeHeap.alloc<CXString>()
        try {
            kniBridge297(results?.getPointer(memScope).rawValue, completion_index, fixit_index, replacement_range?.getPointer(memScope).rawValue, kniRetVal.rawPtr)
            return kniRetVal.readValue()
        } finally { nativeHeap.free(kniRetVal) }
    }
}
...
fun clang_codeCompleteAt(TU: CXTranslationUnit?, complete_filename: String?, complete_line: Int, complete_column: Int, unsaved_files: CValuesRef<CXUnsavedFile>?, num_unsaved_files: Int, options: Int): CPointer<CXCodeCompleteResults>? {
    memScoped {
        return interpretCPointer<CXCodeCompleteResults>(kniBridge299(TU.rawValue, complete_filename?.cstr?.getPointer(memScope).rawValue, complete_line, complete_column, unsaved_files?.getPointer(memScope).rawValue, num_unsaved_files, options))
    }
}
...
fun clang_sortCodeCompletionResults(Results: CValuesRef<CXCompletionResult>?, NumResults: Int): Unit {
    memScoped {
        return kniBridge300(Results?.getPointer(memScope).rawValue, NumResults)
    }
}
...
fun clang_disposeCodeCompleteResults(Results: CValuesRef<CXCodeCompleteResults>?): Unit {
    memScoped {
        return kniBridge301(Results?.getPointer(memScope).rawValue)
    }
}
...
fun clang_codeCompleteGetNumDiagnostics(Results: CValuesRef<CXCodeCompleteResults>?): Int {
    memScoped {
        return kniBridge302(Results?.getPointer(memScope).rawValue)
    }
}
...
fun clang_codeCompleteGetDiagnostic(Results: CValuesRef<CXCodeCompleteResults>?, Index: Int): CXDiagnostic? {
    memScoped {
        return interpretCPointer<COpaque>(kniBridge303(Results?.getPointer(memScope).rawValue, Index))
    }
}
...
fun clang_codeCompleteGetContexts(Results: CValuesRef<CXCodeCompleteResults>?): Long {
    memScoped {
        return kniBridge304(Results?.getPointer(memScope).rawValue)
    }
}
...
fun clang_codeCompleteGetContainerKind(Results: CValuesRef<CXCodeCompleteResults>?, IsIncomplete: CValuesRef<IntVar>?): CXCursorKind {
    memScoped {
        return CXCursorKind.byValue(kniBridge305(Results?.getPointer(memScope).rawValue, IsIncomplete?.getPointer(memScope).rawValue))
    }
}
...
fun clang_codeCompleteGetContainerUSR(Results: CValuesRef<CXCodeCompleteResults>?): CValue<CXString> {
    memScoped {
        val kniRetVal = nativeHeap.alloc<CXString>()
        try {
            kniBridge306(Results?.getPointer(memScope).rawValue, kniRetVal.rawPtr)
            return kniRetVal.readValue()
        } finally { nativeHeap.free(kniRetVal) }
    }
}
...
fun clang_codeCompleteGetObjCSelector(Results: CValuesRef<CXCodeCompleteResults>?): CValue<CXString> {
    memScoped {
        val kniRetVal = nativeHeap.alloc<CXString>()
        try {
            kniBridge307(Results?.getPointer(memScope).rawValue, kniRetVal.rawPtr)
            return kniRetVal.readValue()
        } finally { nativeHeap.free(kniRetVal) }
    }
}
...
fun clang_toggleCrashRecovery(isEnabled: Int): Unit {
    return kniBridge309(isEnabled)
}

@ExperimentalForeignApi
fun clang_getInclusions(tu: CXTranslationUnit?, visitor: CXInclusionVisitor?, client_data: CXClientData?): Unit {
    return kniBridge310(tu.rawValue, visitor.rawValue, client_data.rawValue)
}

@ExperimentalForeignApi
fun clang_Cursor_Evaluate(C: CValue<CXCursor>): CXEvalResult? {
    memScoped {
        return interpretCPointer<COpaque>(kniBridge311(C.getPointer(memScope).rawValue))
    }
}

@ExperimentalForeignApi
fun clang_EvalResult_getKind(E: CXEvalResult?): CXEvalResultKind {
    return CXEvalResultKind.byValue(kniBridge312(E.rawValue))
}
...
fun clang_EvalResult_getAsUnsigned(E: CXEvalResult?): Long {
    return kniBridge316(E.rawValue)
}

@ExperimentalForeignApi
fun clang_EvalResult_getAsDouble(E: CXEvalResult?): Double {
    return kniBridge317(E.rawValue)
}

@ExperimentalForeignApi
fun clang_EvalResult_getAsStr(E: CXEvalResult?): CPointer<ByteVar>? {
    return interpretCPointer<ByteVar>(kniBridge318(E.rawValue))
}

@ExperimentalForeignApi
fun clang_EvalResult_dispose(E: CXEvalResult?): Unit {
    return kniBridge319(E.rawValue)
}

@ExperimentalForeignApi
fun clang_getRemappings(path: String?): CXRemapping? {
    memScoped {
        return interpretCPointer<COpaque>(kniBridge320(path?.cstr?.getPointer(memScope).rawValue))
    }
}
...
fun clang_getRemappingsFromFileList(filePaths: CValuesRef<CPointerVar<ByteVar>>?, numFiles: Int): CXRemapping? {
    memScoped {
        return interpretCPointer<COpaque>(kniBridge321(filePaths?.getPointer(memScope).rawValue, numFiles))
    }
}
...
fun clang_remap_getFilenames(arg0: CXRemapping?, index: Int, original: CValuesRef<CXString>?, transformed: CValuesRef<CXString>?): Unit {
    memScoped {
        return kniBridge323(arg0.rawValue, index, original?.getPointer(memScope).rawValue, transformed?.getPointer(memScope).rawValue)
    }
}

@ExperimentalForeignApi
fun clang_remap_dispose(arg0: CXRemapping?): Unit {
    return kniBridge324(arg0.rawValue)
}

@ExperimentalForeignApi
fun clang_findReferencesInFile(cursor: CValue<CXCursor>, file: CXFile?, visitor: CValue<CXCursorAndRangeVisitor>): CXResult {
    memScoped {
        return CXResult.byValue(kniBridge325(cursor.getPointer(memScope).rawValue, file.rawValue, visitor.getPointer(memScope).rawValue))
    }
}
...
fun clang_findIncludesInFile(TU: CXTranslationUnit?, file: CXFile?, visitor: CValue<CXCursorAndRangeVisitor>): CXResult {
    memScoped {
        return CXResult.byValue(kniBridge326(TU.rawValue, file.rawValue, visitor.getPointer(memScope).rawValue))
    }
}

@ExperimentalForeignApi
fun clang_index_isEntityObjCContainerKind(arg0: CXIdxEntityKind): Int {
    return kniBridge327(arg0.value)
}

@ExperimentalForeignApi
fun clang_index_getObjCContainerDeclInfo(arg0: CValuesRef<CXIdxDeclInfo>?): CPointer<CXIdxObjCContainerDeclInfo>? {
    memScoped {
        return interpretCPointer<CXIdxObjCContainerDeclInfo>(kniBridge328(arg0?.getPointer(memScope).rawValue))
    }
}
...
fun clang_index_getObjCInterfaceDeclInfo(arg0: CValuesRef<CXIdxDeclInfo>?): CPointer<CXIdxObjCInterfaceDeclInfo>? {
    memScoped {
        return interpretCPointer<CXIdxObjCInterfaceDeclInfo>(kniBridge329(arg0?.getPointer(memScope).rawValue))
    }
}
...
fun clang_index_getObjCCategoryDeclInfo(arg0: CValuesRef<CXIdxDeclInfo>?): CPointer<CXIdxObjCCategoryDeclInfo>? {
    memScoped {
        return interpretCPointer<CXIdxObjCCategoryDeclInfo>(kniBridge330(arg0?.getPointer(memScope).rawValue))
    }
}
...
fun clang_index_getObjCProtocolRefListInfo(arg0: CValuesRef<CXIdxDeclInfo>?): CPointer<CXIdxObjCProtocolRefListInfo>? {
    memScoped {
        return interpretCPointer<CXIdxObjCProtocolRefListInfo>(kniBridge331(arg0?.getPointer(memScope).rawValue))
    }
}
...
fun clang_index_getObjCPropertyDeclInfo(arg0: CValuesRef<CXIdxDeclInfo>?): CPointer<CXIdxObjCPropertyDeclInfo>? {
    memScoped {
        return interpretCPointer<CXIdxObjCPropertyDeclInfo>(kniBridge332(arg0?.getPointer(memScope).rawValue))
    }
}
...
fun clang_index_getIBOutletCollectionAttrInfo(arg0: CValuesRef<CXIdxAttrInfo>?): CPointer<CXIdxIBOutletCollectionAttrInfo>? {
    memScoped {
        return interpretCPointer<CXIdxIBOutletCollectionAttrInfo>(kniBridge333(arg0?.getPointer(memScope).rawValue))
    }
}
...
fun clang_index_getCXXClassDeclInfo(arg0: CValuesRef<CXIdxDeclInfo>?): CPointer<CXIdxCXXClassDeclInfo>? {
    memScoped {
        return interpretCPointer<CXIdxCXXClassDeclInfo>(kniBridge334(arg0?.getPointer(memScope).rawValue))
    }
}
...
fun clang_index_getClientEntity(arg0: CValuesRef<CXIdxEntityInfo>?): CXIdxClientEntity? {
    memScoped {
        return interpretCPointer<COpaque>(kniBridge337(arg0?.getPointer(memScope).rawValue))
    }
}
...
fun clang_index_setClientEntity(arg0: CValuesRef<CXIdxEntityInfo>?, arg1: CXIdxClientEntity?): Unit {
    memScoped {
        return kniBridge338(arg0?.getPointer(memScope).rawValue, arg1.rawValue)
    }
}

@ExperimentalForeignApi
fun clang_IndexAction_create(CIdx: CXIndex?): CXIndexAction? {
    return interpretCPointer<COpaque>(kniBridge339(CIdx.rawValue))
}

@ExperimentalForeignApi
fun clang_IndexAction_dispose(arg0: CXIndexAction?): Unit {
    return kniBridge340(arg0.rawValue)
}
...
fun clang_indexSourceFileFullArgv(arg0: CXIndexAction?, client_data: CXClientData?, index_callbacks: CValuesRef<IndexerCallbacks>?, index_callbacks_size: Int, index_options: Int, source_filename: String?, command_line_args: CValuesRef<CPointerVar<ByteVar>>?, num_command_line_args: Int, unsaved_files: CValuesRef<CXUnsavedFile>?, num_unsaved_files: Int, out_TU: CValuesRef<CXTranslationUnitVar>?, TU_options: Int): Int {
    memScoped {
        return kniBridge342(arg0.rawValue, client_data.rawValue, index_callbacks?.getPointer(memScope).rawValue, index_callbacks_size, index_options, source_filename?.cstr?.getPointer(memScope).rawValue, command_line_args?.getPointer(memScope).rawValue, num_command_line_args, unsaved_files?.getPointer(memScope).rawValue, num_unsaved_files, out_TU?.getPointer(memScope).rawValue, TU_options)
    }
}
...
fun clang_indexTranslationUnit(arg0: CXIndexAction?, client_data: CXClientData?, index_callbacks: CValuesRef<IndexerCallbacks>?, index_callbacks_size: Int, index_options: Int, arg5: CXTranslationUnit?): Int {
    memScoped {
        return kniBridge343(arg0.rawValue, client_data.rawValue, index_callbacks?.getPointer(memScope).rawValue, index_callbacks_size, index_options, arg5.rawValue)
    }
}
...
fun clang_indexLoc_getFileLocation(loc: CValue<CXIdxLoc>, indexFile: CValuesRef<CXIdxClientFileVar>?, file: CValuesRef<CXFileVar>?, line: CValuesRef<IntVar>?, column: CValuesRef<IntVar>?, offset: CValuesRef<IntVar>?): Unit {
    memScoped {
        return kniBridge344(loc.getPointer(memScope).rawValue, indexFile?.getPointer(memScope).rawValue, file?.getPointer(memScope).rawValue, line?.getPointer(memScope).rawValue, column?.getPointer(memScope).rawValue, offset?.getPointer(memScope).rawValue)
    }
}
...
fun clang_indexLoc_getCXSourceLocation(loc: CValue<CXIdxLoc>): CValue<CXSourceLocation> {
    memScoped {
        val kniRetVal = nativeHeap.alloc<CXSourceLocation>()
        try {
            kniBridge345(loc.getPointer(memScope).rawValue, kniRetVal.rawPtr)
            return kniRetVal.readValue()
        } finally { nativeHeap.free(kniRetVal) }
    }
}
...
fun clang_Type_visitFields(T: CValue<CXType>, visitor: CXFieldVisitor?, client_data: CXClientData?): Int {
    memScoped {
        return kniBridge346(T.getPointer(memScope).rawValue, visitor.rawValue, client_data.rawValue)
    }
}
...
fun clang_getCursorBinaryOperatorKind(cursor: CValue<CXCursor>): CXBinaryOperatorKind {
    memScoped {
        return CXBinaryOperatorKind.byValue(kniBridge348(cursor.getPointer(memScope).rawValue))
    }
}
...
fun clang_getUnaryOperatorKindSpelling(kind: CXUnaryOperatorKind): CValue<CXString> {
    val kniRetVal = nativeHeap.alloc<CXString>()
    try {
        kniBridge349(kind.value, kniRetVal.rawPtr)
        return kniRetVal.readValue()
    } finally { nativeHeap.free(kniRetVal) }
}
...
fun clang_getCursorUnaryOperatorKind(cursor: CValue<CXCursor>): CXUnaryOperatorKind {
    memScoped {
        return CXUnaryOperatorKind.byValue(kniBridge350(cursor.getPointer(memScope).rawValue))
    }
}
...
fun clang_Cursor_getAttributeSpelling(cursor: CValue<CXCursor>): CPointer<ByteVar>? {
    memScoped {
        return interpretCPointer<ByteVar>(kniBridge351(cursor.getPointer(memScope).rawValue))
    }
}
...
fun clang_getResultTypeAttributes(typeAttributes: CValue<CXTypeAttributes>): CValue<CXTypeAttributes> {
    memScoped {
        val kniRetVal = nativeHeap.alloc<CXTypeAttributes>()
        try {
            kniBridge353(typeAttributes.getPointer(memScope).rawValue, kniRetVal.rawPtr)
            return kniRetVal.readValue()
        } finally { nativeHeap.free(kniRetVal) }
    }
}
...
fun clang_Type_getNullabilityKind(type: CValue<CXType>, attributes: CValue<CXTypeAttributes>): CXNullabilityKind {
    memScoped {
        return CXNullabilityKind.byValue(kniBridge355(type.getPointer(memScope).rawValue, attributes.getPointer(memScope).rawValue))
    }
}
...
fun clang_Type_getNumProtocols(type: CValue<CXType>): Int {
    memScoped {
        return kniBridge356(type.getPointer(memScope).rawValue)
    }
}
...
fun clang_Type_getProtocol(type: CValue<CXType>, index: Int): CValue<CXCursor> {
    memScoped {
        val kniRetVal = nativeHeap.alloc<CXCursor>()
        try {
            kniBridge357(type.getPointer(memScope).rawValue, index, kniRetVal.rawPtr)
            return kniRetVal.readValue()
        } finally { nativeHeap.free(kniRetVal) }
    }
}
...
fun clang_Cursor_isObjCInitMethod(cursor: CValue<CXCursor>): Int {
    memScoped {
        return kniBridge358(cursor.getPointer(memScope).rawValue)
    }
}
...
fun clang_Cursor_isObjCReturningRetainedMethod(cursor: CValue<CXCursor>): Int {
    memScoped {
        return kniBridge359(cursor.getPointer(memScope).rawValue)
    }
}
...
fun clang_Cursor_isObjCConsumingSelfMethod(cursor: CValue<CXCursor>): Int {
    memScoped {
        return kniBridge360(cursor.getPointer(memScope).rawValue)
    }
}
...
private external fun kniBridge4(p0: NativePtr): Long
private external fun kniBridge5(p0: NativePtr, p1: NativePtr): Int
private external fun kniBridge6(p0: NativePtr, p1: NativePtr): Int
private external fun kniBridge7(p0: NativePtr, p1: NativePtr): Unit
private external fun kniBridge8(p0: NativePtr): Unit
private external fun kniBridge9(p0: NativePtr, p1: NativePtr): Int
...
private external fun kniBridge13(p0: NativePtr, p1: NativePtr, p2: NativePtr): Unit
private external fun kniBridge14(p0: NativePtr, p1: NativePtr): Int
private external fun kniBridge15(p0: NativePtr): Int
private external fun kniBridge16(p0: NativePtr, p1: NativePtr, p2: NativePtr, p3: NativePtr, p4: NativePtr): Unit
private external fun kniBridge17(p0: NativePtr, p1: NativePtr, p2: NativePtr, p3: NativePtr): Unit
private external fun kniBridge18(p0: NativePtr, p1: NativePtr, p2: NativePtr, p3: NativePtr, p4: NativePtr): Unit
private external fun kniBridge19(p0: NativePtr, p1: NativePtr, p2: NativePtr, p3: NativePtr, p4: NativePtr): Unit
private external fun kniBridge20(p0: NativePtr, p1: NativePtr, p2: NativePtr, p3: NativePtr, p4: NativePtr): Unit
...
private external fun kniBridge27(): Long
private external fun kniBridge28(p0: Int): NativePtr
private external fun kniBridge29(p0: NativePtr, p1: NativePtr, p2: NativePtr): Int
private external fun kniBridge30(p0: NativePtr, p1: Int): Int
private external fun kniBridge31(p0: NativePtr, p1: Int, p2: NativePtr, p3: NativePtr): Int
private external fun kniBridge32(p0: NativePtr): Unit
private external fun kniBridge33(p0: NativePtr): Unit
private external fun kniBridge34(p0: Int): NativePtr
...
private external fun kniBridge37(p0: NativePtr, p1: Int, p2: NativePtr, p3: NativePtr): Int
...
private external fun kniBridge47(p0: NativePtr, p1: Int, p2: NativePtr): Unit
private external fun kniBridge48(): Int
...
private external fun kniBridge54(p0: Int, p1: NativePtr): Unit
private external fun kniBridge55(p0: NativePtr, p1: NativePtr): Unit
...
private external fun kniBridge59(p0: NativePtr, p1: Int, p2: NativePtr, p3: NativePtr): Unit
private external fun kniBridge60(p0: Int, p1: Int): NativePtr
private external fun kniBridge61(p0: NativePtr): Unit
private external fun kniBridge62(p0: NativePtr): NativePtr
private external fun kniBridge63(p0: NativePtr, p1: Int): Unit
private external fun kniBridge64(p0: NativePtr): Int
private external fun kniBridge65(p0: NativePtr, p1: NativePtr): Unit
private external fun kniBridge66(p0: NativePtr, p1: NativePtr): Int
...
private external fun kniBridge69(p0: NativePtr, p1: NativePtr, p2: Int, p3: Int, p4: NativePtr): Unit
private external fun kniBridge70(p0: NativePtr, p1: NativePtr, p2: Int, p3: NativePtr): Unit
...
private external fun kniBridge77(p0: NativePtr, p1: NativePtr, p2: Int, p3: NativePtr, p4: Int, p5: NativePtr): NativePtr
private external fun kniBridge78(p0: NativePtr, p1: NativePtr): NativePtr
private external fun kniBridge79(p0: NativePtr, p1: NativePtr, p2: NativePtr): Int
private external fun kniBridge80(): Int
private external fun kniBridge81(p0: NativePtr, p1: NativePtr, p2: NativePtr, p3: Int, p4: NativePtr, p5: Int, p6: Int): NativePtr
private external fun kniBridge82(p0: NativePtr, p1: NativePtr, p2: NativePtr, p3: Int, p4: NativePtr, p5: Int, p6: Int, p7: NativePtr): Int
private external fun kniBridge83(p0: NativePtr, p1: NativePtr, p2: NativePtr, p3: Int, p4: NativePtr, p5: Int, p6: Int, p7: NativePtr): Int
private external fun kniBridge84(p0: NativePtr): Int
private external fun kniBridge85(p0: NativePtr, p1: NativePtr, p2: Int): Int
private external fun kniBridge86(p0: NativePtr): Int
private external fun kniBridge87(p0: NativePtr): Unit
private external fun kniBridge88(p0: NativePtr): Int
private external fun kniBridge89(p0: NativePtr, p1: Int, p2: NativePtr, p3: Int): Int
private external fun kniBridge90(p0: Int): NativePtr
...
private external fun kniBridge100(p0: NativePtr): Int
...
private external fun kniBridge111(p0: Int): Int
private external fun kniBridge112(p0: Int): Int
private external fun kniBridge113(p0: Int): Int
...
private external fun kniBridge117(p0: NativePtr, p1: NativePtr, p2: NativePtr, p3: NativePtr, p4: NativePtr, p5: NativePtr, p6: Int): Int
...
private external fun kniBridge127(p0: NativePtr, p1: NativePtr): Int
private external fun kniBridge128(p0: NativePtr, p1: NativePtr): Int
...
private external fun kniBridge132(p0: NativePtr): Unit
private external fun kniBridge133(p0: NativePtr): NativePtr
private external fun kniBridge134(p0: NativePtr, p1: NativePtr, p2: NativePtr): Unit
...
private external fun kniBridge139(p0: NativePtr, p1: NativePtr): Unit
private external fun kniBridge140(p0: NativePtr, p1: NativePtr): Unit
private external fun kniBridge141(p0: NativePtr): Long
private external fun kniBridge142(p0: NativePtr): Long
...
private external fun kniBridge148(p0: NativePtr, p1: Int): Int
private external fun kniBridge149(p0: NativePtr, p1: Int, p2: NativePtr): Unit
private external fun kniBridge150(p0: NativePtr, p1: Int): Long
private external fun kniBridge151(p0: NativePtr, p1: Int): Long
private external fun kniBridge152(p0: NativePtr, p1: NativePtr): Int
...
private external fun kniBridge168(p0: Int, p1: NativePtr): Unit
...
private external fun kniBridge176(p0: NativePtr, p1: Int, p2: NativePtr): Unit
private external fun kniBridge177(p0: NativePtr): Int
private external fun kniBridge178(p0: NativePtr, p1: Int, p2: NativePtr): Unit
...
private external fun kniBridge190(p0: NativePtr): Long
private external fun kniBridge191(p0: NativePtr, p1: NativePtr): Unit
private external fun kniBridge192(p0: NativePtr): Long
private external fun kniBridge193(p0: NativePtr, p1: NativePtr): Long
...
private external fun kniBridge196(p0: NativePtr): Long
...
private external fun kniBridge215(p0: NativePtr, p1: Int, p2: NativePtr, p3: NativePtr): Unit
private external fun kniBridge216(p0: NativePtr, p1: NativePtr, p2: NativePtr): Unit
private external fun kniBridge217(p0: NativePtr, p1: NativePtr): Unit
private external fun kniBridge218(p0: NativePtr, p1: Int, p2: Int, p3: NativePtr): Unit
private external fun kniBridge219(p0: NativePtr, p1: Int): Int
private external fun kniBridge220(p0: NativePtr, p1: Int, p2: Int): Unit
...
private external fun kniBridge232(p0: NativePtr, p1: Int): Int
...
private external fun kniBridge238(p0: NativePtr, p1: NativePtr, p2: NativePtr, p3: NativePtr): Int
...
private external fun kniBridge249(p0: NativePtr, p1: NativePtr): Unit
private external fun kniBridge250(p0: NativePtr, p1: NativePtr): Unit
private external fun kniBridge251(p0: NativePtr): Int
private external fun kniBridge252(p0: NativePtr, p1: NativePtr): Int
private external fun kniBridge253(p0: NativePtr, p1: NativePtr, p2: Int): NativePtr
...
private external fun kniBridge271(p0: NativePtr, p1: NativePtr): Unit
private external fun kniBridge272(p0: NativePtr, p1: Int, p2: Int, p3: NativePtr): Unit
private external fun kniBridge273(p0: NativePtr, p1: NativePtr): NativePtr
...
private external fun kniBridge277(p0: NativePtr, p1: NativePtr, p2: NativePtr): Unit
private external fun kniBridge278(p0: NativePtr, p1: NativePtr, p2: NativePtr, p3: NativePtr): Unit
private external fun kniBridge279(p0: NativePtr, p1: NativePtr, p2: Int, p3: NativePtr): Unit
private external fun kniBridge280(p0: NativePtr, p1: NativePtr, p2: Int): Unit
private external fun kniBridge281(p0: Int, p1: NativePtr): Unit
private external fun kniBridge282(p0: NativePtr, p1: NativePtr, p2: NativePtr, p3: NativePtr, p4: NativePtr, p5: NativePtr, p6: NativePtr): Unit
private external fun kniBridge283(): Unit
private external fun kniBridge284(p0: NativePtr, p1: NativePtr, p2: Int): Unit
private external fun kniBridge285(p0: NativePtr, p1: Int): Int
private external fun kniBridge286(p0: NativePtr, p1: Int, p2: NativePtr): Unit
private external fun kniBridge287(p0: NativePtr, p1: Int): NativePtr
private external fun kniBridge288(p0: NativePtr): Int
private external fun kniBridge289(p0: NativePtr): Int
private external fun kniBridge290(p0: NativePtr): Int
private external fun kniBridge291(p0: NativePtr): Int
private external fun kniBridge292(p0: NativePtr, p1: Int, p2: NativePtr): Unit
...
private external fun kniBridge296(p0: NativePtr, p1: Int): Int
private external fun kniBridge297(p0: NativePtr, p1: Int, p2: Int, p3: NativePtr, p4: NativePtr): Unit
private external fun kniBridge298(): Int
private external fun kniBridge299(p0: NativePtr, p1: NativePtr, p2: Int, p3: Int, p4: NativePtr, p5: Int, p6: Int): NativePtr
private external fun kniBridge300(p0: NativePtr, p1: Int): Unit
...
private external fun kniBridge305(p0: NativePtr, p1: NativePtr): Int
...
private external fun kniBridge309(p0: Int): Unit
...
private external fun kniBridge316(p0: NativePtr): Long
private external fun kniBridge317(p0: NativePtr): Double
...
private external fun kniBridge321(p0: NativePtr, p1: Int): NativePtr
private external fun kniBridge322(p0: NativePtr): Int
private external fun kniBridge323(p0: NativePtr, p1: Int, p2: NativePtr, p3: NativePtr): Unit
private external fun kniBridge324(p0: NativePtr): Unit
private external fun kniBridge325(p0: NativePtr, p1: NativePtr, p2: NativePtr): Int
private external fun kniBridge326(p0: NativePtr, p1: NativePtr, p2: NativePtr): Int
private external fun kniBridge327(p0: Int): Int
...
private external fun kniBridge341(p0: NativePtr, p1: NativePtr, p2: NativePtr, p3: Int, p4: Int, p5: NativePtr, p6: NativePtr, p7: Int, p8: NativePtr, p9: Int, p10: NativePtr, p11: Int): Int
private external fun kniBridge342(p0: NativePtr, p1: NativePtr, p2: NativePtr, p3: Int, p4: Int, p5: NativePtr, p6: NativePtr, p7: Int, p8: NativePtr, p9: Int, p10: NativePtr, p11: Int): Int
private external fun kniBridge343(p0: NativePtr, p1: NativePtr, p2: NativePtr, p3: Int, p4: Int, p5: NativePtr): Int
private external fun kniBridge344(p0: NativePtr, p1: NativePtr, p2: NativePtr, p3: NativePtr, p4: NativePtr, p5: NativePtr): Unit
private external fun kniBridge345(p0: NativePtr, p1: NativePtr): Unit
private external fun kniBridge346(p0: NativePtr, p1: NativePtr, p2: NativePtr): Int
private external fun kniBridge347(p0: Int, p1: NativePtr): Unit
private external fun kniBridge348(p0: NativePtr): Int
private external fun kniBridge349(p0: Int, p1: NativePtr): Unit
private external fun kniBridge350(p0: NativePtr): Int
private external fun kniBridge351(p0: NativePtr): NativePtr
private external fun kniBridge352(p0: NativePtr, p1: NativePtr): Unit
private external fun kniBridge353(p0: NativePtr, p1: NativePtr): Unit
private external fun kniBridge354(p0: NativePtr, p1: NativePtr): Unit
private external fun kniBridge355(p0: NativePtr, p1: NativePtr): Int
private external fun kniBridge356(p0: NativePtr): Int
private external fun kniBridge357(p0: NativePtr, p1: Int, p2: NativePtr): Unit
