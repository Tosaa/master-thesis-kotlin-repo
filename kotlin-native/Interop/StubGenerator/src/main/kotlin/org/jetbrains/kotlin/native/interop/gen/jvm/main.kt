...
fun main(args: Array<String>) {
    ...
    println("main(): args = ${args.joinToString()}\n" +
            ...
            " defFile = ${arguments.def}," +
            " libraryPath = ${(arguments.library + arguments.libraryPath).joinToString()}," +
            " compilerOptions = ${(arguments.compilerOpts + arguments.compilerOptions + arguments.compilerOption).joinToString()}," +
            " linkerOptions = ${(arguments.linkerOption.value + arguments.linkerOpts.value + arguments.linkerOptions.value).joinToString()}," +
            " internalInteropOptions = ${InternalInteropOptions(arguments.generated, arguments.natives)}")
    try {
...
private fun processCLib(
    ...
    def.manifestAddendProperties.putAndRunOnReplace("package", outKtPkg) { _, oldValue, newValue ->
